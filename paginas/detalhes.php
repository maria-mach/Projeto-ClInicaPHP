            ...
            <div class="container py-5">
                ...
                <div id="sec-consultas" class="card shadow-sm mb-5 p-4 border-0">
                    <div class="card-body">
                        ...
                        <div id="btnVerDetalhes" class="mb-3 text-center mt-5 bg-light p-4 rounded shadow-sm border">
                            <button type="button" id="VerDetalhes" class="btn btn-primary btn-ver-detalhes" data-target="infoDetalhes">
                                <i class="fas fa-map-marker-alt me-2"></i>Ver mais detalhes
                            </button>
                        </div>

                        <!-- informações -->
                        <div id="infoDetalhes" class="mb-3" style="display:none;">
                ...
                <div id="sec-exames" class="card shadow-sm mb-5 p-4 border-0">
                    <div class="card-body">
                        ...
                        <!-- imagem -->
                        <div class="text-center mb-4">
                            <img src="<?= esc(url_path('assets/img/medica-injecao.jpg')) ?>" class="img-fluid rounded shadow-sm w-50"
                        ...
                        <!-- informações -->
                        <div id="infoDetalhesExames" class="mb-3" style="display:none;">
                            <div class="card border">
                                <div class="card-body">
                ...
                <div id="sec-cirurgias" class="card shadow-sm mb-5 p-4 border-0">
                    <div class="card-body">
                        ...
                        <!-- informações -->
                        <div id="infoDetalhesCirurgias" class="mb-3" style="display:none;">
                            <div class="card border">
                                <div class="card-body">
