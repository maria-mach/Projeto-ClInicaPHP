                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <li class="user-header cg-bg-secundaria">
                        ...
                        <p>
                            <?= esc($usuario['nome'] ?: 'Usuário') ?>
                            <small>
                                <?= usuario_logado() ? esc($usuario['tipo']) : 'Entre ou crie uma conta' ?>
                            </small>
                        </p>
                    </li>
                    ...
                    <?php if (!usuario_logado()): ?>
                        <li class="user-footer">
                            <a href="<?= esc(url_path('login.php')) ?>" class="btn btn-default btn-flat cg-border-secundaria">Entrar</a>
                            <a href="<?= esc(url_path('cadastro.php')) ?>" class="btn btn-default btn-flat cg-border-secundaria float-end">Cadastro</a>
                        </li>

                    <?php elseif ($usuario['tipo'] === 'cliente'): ?>
                        <li><a class="dropdown-item" href="<?= esc(url_path('cliente/perfil.php')) ?>">Meu Perfil</a></li>
                        <li><a class="dropdown-item" href="<?= esc(url_path('cliente/meus_agendamentos.php')) ?>">Meus Agendamentos</a></li>
                        <li><a class="dropdown-item text-danger" href="<?= esc(url_path('auth/logout.php')) ?>">Sair</a></li>

                    <?php else: ?>
                        <li><a class="dropdown-item" href="<?= esc(url_path('admin/dashboard.php')) ?>">Dashboard</a></li>
                        <li><a class="dropdown-item" href="<?= esc(url_path('cliente/perfil.php')) ?>">Meu Perfil</a></li>
                        <li><a class="dropdown-item text-danger" href="<?= esc(url_path('auth/logout.php')) ?>">Sair</a></li>
                    <?php endif; ?>
                </ul>
