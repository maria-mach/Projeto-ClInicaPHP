                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <img src="./assets/img/medicos-sorrindo.jpg" class="w-100 rounded"
                                    ...
                                    <div class="carousel-item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <img src="./assets/img/exames.jpeg" class="w-100 rounded"
                                    ...
                                    <div class="carousel-item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <img src="./assets/img/familia-hospital.avif" class="w-100 rounded"
                ...
                <div class="container">
                    <div class="row mt-5 mb-4 px-3">
                        <div class="col-12 d-flex justify-content-between border-top pt-4">
                            <div></div>
                            <a href="empresa.php" class="text-decoration-none text-primary fw-bold">Empresa</a>
                        </div>
                    </div>
                </div>
            </div> <!-- /app-content -->
